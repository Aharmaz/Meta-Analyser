...
public class EspaceEtudiantFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        Button btn3 = (Button) rootView.findViewById(R.id.ajouter_grp_etudiant_btn);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.sujets_prop_etudiant_btn:
                fragment = new SujetsPropsEtudiantFragment();
            ...
            case R.id.suivi_etudiant_btn:
                ...
                replaceFragment(fragment);
                break;
            case R.id.ajouter_grp_etudiant_btn:
                fragment = new AjouterGrpEtudiantFragment();
                replaceFragment(fragment);
                break;
            case R.id.choisir_sujets_etudiant_btn:
                fragment = new ChoisirSujetsEtudiantFragment();
                replaceFragment(fragment);
                break;
